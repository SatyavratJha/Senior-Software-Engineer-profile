      ...
      <div className="container">
        ...
        <div className="about-content">
          <div className="about-text">
            ...
            <p>
              With 6 years of experience as a Middleware Administrator in a
              production support, I've developed a deep understanding of
              enterprise systems, integration patterns, and infrastructure
              management.
            </p>
            <p>
              Now I'm transitioning to software development, focusing on modern
              web technologies like React.js, Node.js, and cloud platforms. My
              background gives me a unique perspective on how applications
              interact with infrastructure and middleware components.
            </p>
            <p>
          ...
          <div className="skills">
            <div className="skill-chip">Redhat JBoss</div>
